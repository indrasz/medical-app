          ...
          <div class="collapse navbar-collapse" id="topnav-menu-content4">
            ...
            <ul class="navbar-nav align-items-center">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="notifications" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="icon-xs">
                      <?xml version="1.0" encoding="UTF-8"?>
                      <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
                          ...
                          <desc>Created with Sketch.</desc>
                          <g id="Stockholm-icons-/-General-/-Notification#2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                              ...
                              <circle id="Oval" fill="#335EEA" opacity="0.3" cx="18.5" cy="5.5" r="2.5"></circle>
                          </g>
                      </svg>
                    </span>
                </a>
                <div class="dropdown-menu p-2" aria-labelledby="notifications">
                  ...
                  <a class="dropdown-item p-2" href="#">
                    <div class="d-flex align-items-center">
                      <span class="bg-soft-primary avatar avatar-xs rounded icon icon-with-bg icon-xxs text-primary me-3 flex-shrink-0">
                        <?xml version="1.0" encoding="UTF-8"?>
                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
                  ...
                  <a class="dropdown-item p-2" href="#">
                    <div class="d-flex align-items-center">
                      <span class="bg-soft-orange avatar avatar-xs rounded icon icon-with-bg icon-xxs text-orange me-3 flex-shrink-0">
                        <?xml version="1.0" encoding="UTF-8"?>
                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
                  ...
                  <a class="dropdown-item p-2" href="#">
                    <div class="d-flex align-items-center">
                      <span class="bg-soft-success avatar avatar-xs rounded icon icon-with-bg icon-xxs text-success me-3 flex-shrink-0">
                        <?xml version="1.0" encoding="UTF-8"?>
                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
                  ...
                  <a class="dropdown-item p-2" href="#">
                    <div class="d-flex align-items-center">
                      <span class="bg-soft-danger avatar avatar-xs rounded icon icon-with-bg icon-xxs text-danger me-3 flex-shrink-0">
                        <?xml version="1.0" encoding="UTF-8"?>
                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
                            <title>Stockholm-icons / General / Like</title>
                            <desc>Created with Sketch.</desc>
                            <g id="Stockholm-icons-/-General-/-Like" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                <path d="M9,10 L9,19 L10.1525987,19.3841996 C11.3761964,19.7920655 12.6575468,20 13.9473319,20 L17.5405883,20 C18.9706314,20 20.2018758,18.990621 20.4823303,17.5883484 L21.231529,13.8423552 C21.5564648,12.217676 20.5028146,10.6372006 18.8781353,10.3122648 C18.6189212,10.260422 18.353992,10.2430672 18.0902299,10.2606513 L14.5,10.5 L14.8641964,6.49383981 C14.9326895,5.74041495 14.3774427,5.07411874 13.6240179,5.00562558 C13.5827848,5.00187712 13.5414031,5 13.5,5 L13.5,5 C12.5694044,5 11.7070439,5.48826024 11.2282564,6.28623939 L9,10 Z" id="Path-42" fill="#335EEA"></path>
                                <rect id="Rectangle-153" fill="#335EEA" opacity="0.3" x="2" y="9" width="5" height="11" rx="1"></rect>
                            </g>
                        </svg>
                      </span>
                      <div class="flex-grow-1">
                ...
                <a class="nav-link dropdown-toggle py-0" href="#" id="user" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-1 lh-base">
                      <span class="fw-semibold fs-13 d-block line-height-normal text-capitalize">{{ Auth::user()->name }}</span>
                                        ...
                                        <div class="col">
                                            <div class="avatar-group">
                                                <a href="" class="avatar-group-item mb-0">
                                                    <img src="./assets/images/avatars/img-8.jpg" alt="image"
                                                        class="img-fluid avatar-xs rounded rounded-circle avatar-border" />
                                                </a>
                                                <a href="" class="avatar-group-item mb-0">
                                                    <img src="./assets/images/avatars/img-5.jpg" alt="image"
                                                        class="img-fluid avatar-xs rounded rounded-circle avatar-border" />
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="row align-items-center">
                <div class="col">
                    <ul class="list-inline list-with-separator mb-0">
                        ...
                        <li class="list-inline-item me-0"><a href="#">Careers <span class="align-middle badge badge-soft-info rounded-pill fw-normal fs-11 px-2 py-1">We're hiring</span></a></li>
                    </ul>
                </div>
                <div class="col-md-auto text-md-end mt-2 mt-md-0">
                    <p class="fs-14 mb-0"><script>document.write(new Date().getFullYear())</script> © Prompt. All rights reserved. Crafted by <a href="https://coderthemes.com/">Coderthemes</a></p>
                </div>
            </div>
        </div>
    </section>
